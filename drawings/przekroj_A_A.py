...
def draw_arcs(model_space, sheet):
    ...
    for row in range(376, 380):
        ...
        print("Łuk przekroju A-A narysowany")
...
def draw_hatch(model_space, sheet):
    ...
    for main_key in hatch_areas:
        ...
        if main_key == str(sheet.cell(325, 25).value):
            row += 1
