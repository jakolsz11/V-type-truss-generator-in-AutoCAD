...
def draw_lines1(model_space, sheet):
    ...
    for row in range(94, 100):
        ...
        print("Linia przekroju KR narysowana")   
...
def draw_arcs1(model_space, sheet):
    ...
    for row in range(58, 61):
        ...
        print("Łuk przekroju KR narysowany")
...
def draw_hatch1(model_space, sheet):
    ...
    pattern = str(sheet.cell(66, 32).value) 
    scale = float(sheet.cell(66, 33).value) 
    angle = float(sheet.cell(66, 34).value) 
    layer = str(sheet.cell(66, 35).value)   
...
def draw_przekroj_krzyzulca_rozciaganego(doc):
